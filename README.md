...
| | |
|---|---|
| **Database** | Live and tested. Nine migrations applied to the hosted project; 21 assertions pass against a scratch Postgres; Supabase's linter reports nothing. |
