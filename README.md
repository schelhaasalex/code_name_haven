...
| | |
|---|---|
| **Database** | Live and tested. Seven migrations applied to the hosted project; 20 assertions pass against a scratch Postgres; Supabase's linter reports nothing. |
